...
SIGMA_T1 = 2.5        # exploration noise std for T1
SIGMA_T2 = 2.5        # exploration noise std for T2
LAMBDA = 10.0         # temperature (lower = more selective)
...
def batched_cost(drone_traj, cable_traj, theta_traj, controls, target):
    ...
    for t in range(Hp1):
        ...
        costs += 8.0 * dev_from_center * near_gap
    ...
    CORNER_RADIUS = 0.20  # influence radius
    for t in range(Hp1):
        ...
        for ci in range(4):
            ...
            costs += 3000.0 * np.sum(penetration**2, axis=1)
...
plt.tight_layout()
plt.savefig('/home/claude/mppi_quad2d_analysis.png', dpi=150, bbox_inches='tight')
print("Saved: mppi_quad2d_analysis.png")
...
ani.save('/home/claude/mppi_quad2d.gif', writer='pillow', fps=10)
print("Saved: mppi_quad2d.gif")
plt.close('all')
print("\n✓ Done!")
